...
function App() {
  return (
    <Routes>
      ...
      <Route
        path="/dashboard/:id/column/:columnId"
        element={<h1>ColumnDashboard</h1>}
      />
      <Route
        path="/dashboard/:id/column/:columnId/edit"
        element={<h1>EditColumnDashboard</h1>}
      />
      <Route
        path="/dashboard/:id/column/:columnId/task/:taskId"
        element={<h1>Task </h1>}
      />
      <Route
        path="/new-task-dashboard/:id/column/:columnId/task"
        element={<h1>NewTaskDashboard</h1>}
      />
      <Route
        path="/edit-task-dashboard/:id/column/:columnId/task/:taskId/edit"
        element={<h1>EditTaskDashboard</h1>}
      />
    </Routes>
  );
}
